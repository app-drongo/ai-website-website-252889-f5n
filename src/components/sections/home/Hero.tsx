...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'InvoicePro',
  description:
    'Create, send, and track professional invoices in minutes. Automate your billing workflow and get paid faster with our intelligent invoicing platform.',
  features: [
  ...
  imageAlt: 'InvoicePro dashboard showing invoice management',
