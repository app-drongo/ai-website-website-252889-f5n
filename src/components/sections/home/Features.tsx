...
const DEFAULT_FEATURES = {
  badge: 'Core Features',
  mainTitle: 'Professional Invoicing Made Simple',
  mainTitleHighlight: 'Built for Growing Businesses',
  mainDescription:
    'Create, send, and track professional invoices in minutes. Our comprehensive invoicing platform helps you get paid faster and manage your finances with confidence.',
  feature1Title: 'Instant Invoice Creation',
  feature1Description:
    'Generate professional invoices in seconds with customizable templates, automated calculations, and smart client data management.',
  feature1Badge: 'Speed',
  feature2Title: 'Bank-Level Security',
  feature2Description:
    'Your financial data is protected with 256-bit encryption, secure payment processing, and SOC 2 Type II compliance.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Invoice Management',
  feature3Description:
    'Create, send, and track invoices on the go with our native mobile apps for iOS and Android devices.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Currency Support',
  feature4Description:
    'Invoice clients worldwide with support for 150+ currencies and automatic exchange rate updates.',
  feature4Badge: 'Global',
  feature5Title: 'Advanced Payment Analytics',
  feature5Description:
    'Track payment patterns, cash flow trends, and client behavior with detailed reports and visual dashboards.',
  feature5Badge: 'Analytics',
  feature6Title: 'Custom Branding & Templates',
  feature6Description:
    'Personalize invoices with your logo, colors, and custom fields to maintain professional brand consistency.',
  feature6Badge: 'Branding',
  feature7Title: 'API & Integrations',
  feature7Description:
    'Connect seamlessly with QuickBooks, Xero, Stripe, PayPal, and 50+ other business tools via REST API.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Customer Success',
  feature8Description:
    'Get dedicated support from invoicing specialists with live chat, phone support, and onboarding assistance.',
  feature8Badge: 'Support',
  feature9Title: 'Data Privacy & Backup',
  feature9Description:
    'Your invoicing data is automatically backed up, encrypted at rest, and never shared with third parties.',
  feature9Badge: 'Privacy',
  ctaQuestion: 'Ready to streamline your invoicing process?',
